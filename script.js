window.addEventListener('load', function () {
    ...
    class Larva {
        ...
        draw(context) {
            ...
            if (this.game.debug) {
                ...
                context.stroke();
                const displayTimer = (this.hatchTimer * 0.001).toFixed(0);
                context.fillText(this.hatchTimer, this.collisionX, this.collisionY - this.collisionRadius * 2.5);
            }
        }
        update(){
    ...
    class Enemy {
        ...
        draw(context){
            context.drawImage(this.image, this.frameX * this.spriteHeight, this.frameY * this.spriteHeight, this.spriteWidth, this.spriteHeight, this.spriteX, this.spriteY, this.width, this.height);
            if (this.game.debug) {
                context.beginPath();
                context.arc(this.collisionX, this.collisionY, this.collisionRadius, 0, Math.PI * 2);
                context.save();
        ...
        update(){
            ...
            if (this.spriteX + this.game.width < 0 && !this.game.gameOver) {
                this.collisionX = this.game.width + this.width + Math.random() * this.game.width * 0.5;
                this.collisionY = this.game.topMargin + (Math.random() * (this.game.height - this.game.topMargin));
                this.frameY = Math.floor(Math.random() * 4);
            }
